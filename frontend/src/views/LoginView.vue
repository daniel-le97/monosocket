...
const isLogin = route.name?.toString().includes('login')
    ...
    <div class="bg-white p-8 rounded-md w-full sm:w-96 shadow-xl">
      ...
      <form @submit.prevent="handleSubmit(name)">
        <div class="mb-4">
          ...
          <input
            id="email" v-model=" email " autocomplete="email" type="email" name="email"
        ...
        <div class="mb-6">
          ...
          <input
            id="password" v-model=" password " type="password" name="password"
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <a
              ...
              class="text-sm text-gray-600 hover:underline border border-indigo-950 p-2 rounded"
            >
